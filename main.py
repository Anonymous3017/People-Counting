...
if __name__ == "__main__":
    ip_cam_address = "http://192.168.19.151:4747/video"  # input("Enter the address of the IP Camera: ")
    alert_recipient = "ayushgupta9592@gmail.com"  # input("Enter email address of alert recipient: ")
